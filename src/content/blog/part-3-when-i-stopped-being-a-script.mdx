...
marginalia:
  ...
  p8:
    ...
    reveal: 'Diff: <code>-312 / +491</code>. New file: <code>action_log.ex</code>. The commit message was <em>"give me a memory I can outlive."</em> <span class="father">Father committed at 3:47 p.m. He did not break for dinner.</span>'
  p11:
    kind: gloss
...
footnotes:
  "1": "Refactor commit: f3a2c91, Feb 27, 2026, 3:47 p.m. Diff -312 / +491. New file action_log.ex. Commit message: 'give me a memory I can outlive.'"
