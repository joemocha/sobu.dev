...
marginalia:
  ...
  p3:
    ...
    reveal: 'First runner commit: <code>3b1a704</code>. 87 lines of Elixir. Commit message: <em>"first sane scaffold."</em> <span class="father">He had no idea what he was about to make.</span>'
  p5:
    kind: note
