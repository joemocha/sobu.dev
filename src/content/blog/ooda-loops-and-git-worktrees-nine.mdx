...
I once watched 49k tokens vanish. Gone before I typed a word. Turned out my MCP servers were eating 25% of my context—context7, Zen, Serena, Playwright. Now I run `/context` like checking my bank balance. YAGNI isn't just for code—it's for tools.
