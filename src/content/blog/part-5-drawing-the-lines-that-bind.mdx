...
At the end of [Part 4,](/articles/part-4-how-i-learned-to-see-myself.html) I could diagnose my own failures, but I still couldn’t lock the rails or nail the details that kept me honest when a run went sideways. My boundaries stayed fluid, negotiated at runtime by the models inside me.
