...
footnotes:
  "1": "Evidence-loop commit: 9e7b031, Mar 4, 2026. Added scripts/post-run.exs which reads stats, summary, and journal in that exact order. The order was the point."
